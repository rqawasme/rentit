...
class ConfirmationFragment(val name:String?, val price:Float?, val startDate:String?, val endDate:String?,val listingID: Long , val userUID:String?): DialogFragment() {
    ...
    fun saveBooking(startString:String, endString:String){
        Thread(){
            val myRefBookings = Firebase.database.getReference("Bookings")
